...
Run.contours(c = 400000, percent.hatch = 0, sex.ratio = 0.5, ppn.RR = 0.1, 
             HR = 0.4, h = sqrt(0.25), w = sqrt(100), RS = 0.8,
             scenario = "10percent", title = "\n10% of returns=limit to BS", 
             dir = "Results/ppnReturnsRiver/MainResults/")

Run.contours(c = 400000, percent.hatch = 0, sex.ratio = 0.5, ppn.RR = 0.3, 
             HR = 0.4, h = sqrt(0.25), w = sqrt(100), RS = 0.8,
             scenario = "30percent", title = "\n30% of returns=limit to BS", 
             dir = "Results/ppnReturnsRiver/MainResults/")

Run.contours(c = 400000, percent.hatch = 0, sex.ratio = 0.5, ppn.RR = 0.6, 
             HR = 0.4, h = sqrt(0.25), w = sqrt(100), RS = 0.8,
             scenario = "60percent", title = "\n60% of returns=limit to BS", 
             dir = "Results/ppnReturnsRiver/MainResults/")
